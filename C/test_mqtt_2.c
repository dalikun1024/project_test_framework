...
int test1()
{
  ...
  for (int i = 1; i < 1001; ++i) {
	...
	assert("Sum of integers for a longer vector",  sum_integers(integers, sizeof(integers)/sizeof(int)) == 500500, "res was %d\n", sum_integers(integers, sizeof(integers)/sizeof(int)));
	if (sum_integers(integers, sizeof(integers)/sizeof(int)) != 500500)
	{
		failures = 1;
	}
	return failures;
